...
const RBArticle = () => {
  ...
  return (
    <div>
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "RB" && item.games_played >= 8 && item.ppg < 15)
          .reverse()}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "RB" && item.games_played < 8 && item.ppg < 6)
          .reverse()}
        selectedTeam={selectedTeam}
      />
    </div>
...
const WRArticle = () => {
  ...
  return (
    <div>
      ...
      <RecapPositionTable
        data={starterData.filter(
          (item) => item.position === "WR" && item.games_played >= 8 && item.ppg >= 15
        )}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData.filter(
          (item) => item.position === "WR" && item.games_played < 8 && item.ppg >= 14
        )}
        selectedTeam={selectedTeam}
      />
...
const ThankYouArticle = () => {
  return (
    <div>
      ...
      <p>
        Thank you for reading the 2025 Season Recap. We hope you enjoyed it, and we are looking
