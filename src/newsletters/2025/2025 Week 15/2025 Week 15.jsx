...
const AwardsAndRecapArticle = () => {
  return (
    <div>
      ...
      <p>
        Just as everyone predicted, Kyle Pitts and Trevor Lawrence were the two players you would
        want the most in week 15. For many managers of these players, they still didn't get to
        advance in the playoffs because they were in the toilet bowl, which was true in this league.
        Kyle Pitts was this weeks MVP with over 30% of 2nd Half Team's points this week. His 45.6
        points was obviously TE1 this season, and these points accounted for 7% of Kyle Pitts'
        career fantasy point total. Trevor Lawrence was our #1 Bench MVP of the season, putting up
        44.3 points on the bench for Super Ja'Marrio Bros. this week, contributing to them have the
        6th warmest bench of the season.
      </p>
      ...
      <p>
        It was a pretty inefficient week all around, with the best manager at 96.5% in the toilet
        bowl. WalterPickens scored the fewest points this week, but could've managed their way out
        of that if they started Jacoby Brissett over Joe Burrow, which would've pushed them over the
        edge in their matchup as well. The Barkley Brawlers scored the most points and had the most
        potential this week, but their opponent had the lowest potential of any team. Their Mickey
        Mouse schedule continues into the playoffs.
      </p>
    </div>
  );
};
...
const MotwArticle = () => {
  return (
    <div>
      ...
      <p>
        Uncle Rico Went Pro got their 2nd straight win against WalterPickens and their 3rd straight
        MotW win against a divisional opponent. They didn't put up a great score this week, scoring
        less than 110 for the 2nd straight week, but both times it was enough to get the win. Jaxson
        Dart and George Kittle were the top scorers with each of them scoring more than 22 points.
        Chase Brown, Cam Little, Rashee Rice, and Davante Adams all put up double digits as well.
      </p>
      <p>
        WalterPickens is eating 5 hotdogs for the 2nd straight week, and both could've been avoided
        if they made the opposite QB start/sit decision in both weeks. Last week they started
        Brissett over Burrow and this week it was Burrow over Brissett, both were the wrong choice.
        TreVeyon Henderson tried his best to be a league winner, but couldn't overcome the rest of
        the teams shortcomings.
      </p>
      <MatchupPlot data={starterData} matchupId={1} />
      <p>
        After 3 MotW matches in 5 weeks between these 2 teams, they are finally safe from matching
        up with one-another for the rest of this season. Uncle Rico Went Pro moves into the
        semi-finals against 1st Half Team. WalterPickens will be in the 5th place game against Lord
        of the Littles.
      </p>
      ...
      <p>
        Uncle Rico Went Pro earned their 11th MotW victory, 2nd most all-time. Their 45 shots/dogs
        given out is also 2nd most all-time. WalterPickens lost their league record 4th MotW of the
        season, and 8th MotW of all time, tied for 2nd most all-time. Their 34 shots/dogs consumed
        is 2nd most all-time. Their 15 shots/dogs this season is the 2nd highest total for one
        manager in any season.
      </p>
...
const MatchupArticleTwo = () => {
  return (
    <div>
      ...
      <p>
        Lord of the Littles had Puka Nacua go for 27.9 points this week but struggled to get points
        from the majority of their team which left them with a total of 108.06 points this week.
        They had 5 players with less than 10, and their QB scored less than 12 points. The only
        other player who did relatively well was De'Von Achane who scored 18.7 points.
      </p>
      <p>
        The Barkley Brawlers again didn't really care that they opponent shit the bed, since they
        scored the most points of any team who had a matchup this week at 152.08 points. Michael
        Wilson continues to be Puka Nacua when Marvin Harrison Jr doesn't play. His 37.2 points
        combined with Cameron Dicker's 22 and MIA's 17 would've won them this week without any other
        player contributing.
      </p>
      <MatchupPlot data={starterData} matchupId={2} />
      <p>
        Lord of the Littles will be in the 5th place game against WalterPickens in week 15. The
        Barkley Brawlers will be up against the #2 seed BBCU who had the most PF this season and
        scored 175.2 points in week 15 against nobody.
      </p>
    </div>
  );
};
...
const MatchupArticleThree = () => {
  return (
    <div>
      ...
      <p>
        First Down Syndrome was saving the 2nd highest score of the season for the first round of
        the toilet bowl. Their 138.2 points came largely from 4 players, Amon-Ra, Nico, Hurts, and
        D'Andre Swift. The rest of their players scored below 7.5 points this week.
      </p>
      <p>
        Super Ja'Marrio Bros. scored a respectable 124.58 points this week, which outscored 3 of the
        4 playoff teams. Their defense was their only player below 7.5 points this week, but they
        didn't have any boom games like their opponent having Amon-Ra. Since this was a toilet bowl
        game, they will have to do 3 shots/dogs for their 2 RBs and their DEF, which isn't too bad
        to start off with.
      </p>
      <MatchupPlot data={starterData} matchupId={4} />
      <p>
        First Down Syndrome will be in the 8th place game against 2nd Half Team in week 15. Super
        Ja'Marrio Bros. gets flushed to a matchup with Bye Week Curious who is at risk of adding a
        music video to their punishment with 2 more losses.
      </p>
    </div>
  );
};
...
const MatchupArticleFour = () => {
  return (
    <div>
      ...
      <p>
        2nd Half Team got one of the best TE performances in NFL history from Kyle Pitts this week
        who scored 45.6 points. Josh Allen and Jameson Williams also popped off for 24.52 and 26.4
        points respectively. The rest of their team was also pretty strong aside from their defense
        who only scored 1 point.
      </p>
      <p>
        Costco Guys didn't have anyone score over 20 which makes it impossible to compete with Kyle
        Pitts. Kenneth Gainwell and Tony Pollard were their top scorers, which shows you why they
        are in the toilet bowl this season. Jahmyr Gibbs continues his every other week production,
        booming in even numbered weeks and busting in odd numbered weeks. Since this was a toilet
        bowl game, they will have to do 3 shots/dogs for Jahmyr Gibbs, Jake Ferguson and HOU DEF,
        which isn't too bad to start off with.
      </p>
      <MatchupPlot data={starterData} matchupId={5} />
      <p>
        2nd Half Team will be in the 8th place game against First Down Syndrome in week 15. Costco
        Guys gets flushed to a matchup with Singing Like Mariah Terry in round 2 of the toilet bowl.
      </p>
    </div>
  );
};
...
const ScoringDistributionArticle = () => {
  return (
    <div>
      ...
      <p>
        If we included teams that didn't have any matchups here, the distribution would be a lot
        wider.
      </p>
      <WeeklyScoringChart chartData={matchupData} />
      <ArticleCaption>Weekly Scoring Chart</ArticleCaption>
      <p>
        This week had a higher floor that usual, but we had 4 fewer teams playing. We would've had a
        lower low and a higher high if we included all teams.
      </p>
      ...
      <p>
        There were no close games in the first round of the playoffs; we will see if that trend
        continues next week.
      </p>
    </div>
  );
...
const LeagueBuzzArticle = () => {
  return (
    <div>
      ...
      <p>
        Congratulations to Nikhil for winning a very drawn out 2nd round of survivor after picking
        Alec to win this week. Josh hedged his bets and picked Trevor to beat him in the playoffs,
        and won the game but lost survivor. They lost the fight but they could still win the battle
        if they can advance to the finals they will make more money than they would've from
        survivor. The website will be updated next season to properly support multiple rounds of
        survivor and the special case where people all lose the last week and it keeps going.
      </p>
      <ArticleSubheader>League Submissions</ArticleSubheader>
      <LeagueQuote>
        "Jake is America's team"
        <br />- Anonymous League Manager
      </LeagueQuote>
      <p>
        There are a couple different ways this could be interpreted. The first, most obvious, and
        likely intended way is that they are America's team in the same way that whoever is playing
        the Chiefs is America's team since he is playing Anthony in the playoffs. The other way this
        could be interpreted is that they are America's team in the same way that the Patriots are
        America's team this year and they have by far the easiest schedule in the league.
      </p>
    </div>
  );
};
...
const Meme1 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/UQ1nSaT.png"}></ArticleImage>
...
const Meme2 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/OGHnP7m.png"}></ArticleImage>
      <ArticleCaption>Submitted Anonymously</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme3 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/GQnuUHy.png"}></ArticleImage>
...
const Meme4 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/zwBt4Bf.png"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme5 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/DQM6g9e.png"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme6 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/kkbzSpN.png"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme7 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/zAfBFLw.png"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme8 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgur.com/30CtIaq.png"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
