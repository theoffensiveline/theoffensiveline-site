...
const AwardsAndRecapArticle = () => {
  return (
    <div>
      ...
      <p>
        Week 17 saw the greatest championship final in league history, as well as the lowest scoring
        matchup in league history thanks to two rule breaking managers. The championship matchup
        came down to a MNF showdown between Jahmyr Gibbs and Amon-Ra St. Brown. Entering the Lions
        final drive of the game, Costo Guys held a slim lead, 147.42 to 144.88 points over Pink Pony
        Kupp. With the Lions leading in the game, it was unclear whether Gibbs would be on the field
        for the final drive. He ended the game with an 8 yard carry, a 4 yard carry, and finally a
        30 yard TD run that sealed the game for the Lions and Pink Pony Kupp. This also helped
        elevate Gibbs to the RB1 started in our league this week. Costo Guys ended with 147.42
        points, which was the #1 Best Loser this season, and they only left 0.3 points on the bench.
        They had the Biggest D this week, PHI, who scored 19 points.
      </p>
      <p>
        Now to the two rule breakers, League Loser Prophecy and Twin Bowers. These two faced off in
        the 10th place game, and mutually agreed to violate Article IV of the bylaws by not setting
        their best possible lineup. They set up a 1v1 kicker showdown between Dicker the Kicker and
        Jake (Master) Bates. Dicker the Kicker ended up scoring the most points of any kicker this
        week, helping League Loser Prophecy win the game, and be the Worst Winner in league history.
        Twin Bowers meanwhile was the Most Mismanaged Team and also had the Warmest Bench, leaving
        103.3 points on their bench.
      </p>
      ...
      <p>
        The top 2 scoring teams were the finalists, and both managed at over 95% efficiency in the
        most important game of the season. Just Joshin pt. 2 had the worst management of any team
        who actually tried to set a lineup this week.
      </p>
    </div>
  );
};
...
const MotwArticle = () => {
  return (
    <div>
      ...
      <p>
        Costo Guys put up a solid performance in the championship. Every other team this season who
        scored more than 147 points won their matchup. Malik Nabers was their best player, scoring
        36.1 points in the Drew Lock masterclass. Lamar Jackson helped out adding in nearly 30
        points of his own, and Amon-Ra and PHI D put in 20 and 19 respectively. They were let down
        by Nico Collins, Breece Hall, and Chris Boswell.
      </p>
      <p>
        Pink Pony Kupp put up 155.08 points in the championship, the most points scored in a
        championship game in recorded league history. Joe Burrow put up 36.98 points, which he
        needed OT to do. Jahmyr Gibbs, Bucky Irving, Jalen McMillan, and Brian Thomas all scored 23
        or more points. They were let down by namesake Cooper Kupp and new-to-them TE Hunter Henry.
        Their K and DEF each chipped in 9 points.
      </p>
      <MatchupPlot data={starterData} matchupId={1} />
      <p>Pink Pony Kupp took home 80% of the prize, and Costo Guys took home the other 20%.</p>
...
const MatchupArticleTwo = () => {
  return (
    <div>
      ...
      <p>
        Calvin's Cold Streak scored the least points of any team who tried to set their lineup this
        week. Travis Kelce was the one major bright spot on this team, scoring 22.4 points. TB
        defense and Jordan Addison had the next best performances relative to expectation. This team
        was let down by Geno Smith and Alexander Mattison, and ended up losing the 3rd place game.
      </p>
      <p>
        Just Joshin pt. 2 was able to get this win thanks in large part to Ladd McConkey, Bijan
        Robinson, and Josh Allen. They also got respectable games from Aaron Jones, DJ Moore, Chig,
        and their K & DEF. James Conner got hurt early in his game, leading to a dud from him. Third
        place doesn't win this manager any money, but they might get a sense of pride and
        accomplishment out of back-to-back top-3 finishes.
      </p>
...
const MatchupArticleFour = () => {
  return (
    <div>
      ...
      <p>
        First Down Syndrome put up 130.14 points, their 2nd highest point total of the season, only
        behind their victory to avoid last place in week 14. This team nearly clutched up yet again,
        but couldn't score enough because of their RBs and DEF shitting the bed. The rest of their
        players did about as well as you could hope, with 5 of them scoring over 19 points, and they
        got 11.3 from their kicker. If only they got more than 5.3 total points from their RBs and
        DEF.
      </p>
      <p>
        Njorkin da Tenis was able to get the win in the all-important toilet bowl final. Jayden
        Daniels, Tee Higgins, and Puka Nacua came in clutch for them, and Rhamondre, Ferguson, and
        NO DEF disappointed them. Tyjae Spears and Travis Etienne scored a lot more than their
        opponents RBs, which helped them secure the win.
      </p>
      <MatchupPlot data={starterData} matchupId={4} />
      <p>First Down Syndrome will be releasing a song as a result of this loss.</p>
    </div>
  );
};
...
const MatchupArticleFive = () => {
  return (
    <div>
      ...
      <p>
        There isn't much to discuss in this matchup. Dicker the Kicker scored 18.4 points to propel
        League Loser Prophecy to victory.
      </p>
      <p>
        Jake Bates scored 9.9 points leading Twin Bowers to a loss. These two messed up the league's
...
const ScoringDistributionArticle = () => {
  return (
    <div>
      ...
      <p>This chart is so much less helpful now with such a low end.</p>
      <WeeklyScoringChart chartData={matchupData} />
      <ArticleCaption>Weekly Scoring Chart</ArticleCaption>
      <p>
        We had our highest median score of the season, and the lowest average thanks to our kicker
        face-off.
      </p>
      ...
      <p>
        3 out of the 4 games this week were close. Pink Pony Kupp earned their 2nd close victory,
        while Costo Guys took their 3rd close defeat. Njorkin da Tenis earned their 2nd close
        victory, while First Down Syndrome took their 3rd close defeat. League Loser Prophecy earned
        their 2nd close victory, while Twin Bowers took their 4th close defeat.
      </p>
    </div>
  );
};
...
const LeagueBuzzArticle = () => {
  return (
    <div>
      ...
      <LeagueQuote>
        "Thank you guys for tuning in. 24 hours, wow. What a night. What a day of adventures. ...
        Thanks to everyone out there, thanks to Colin Hodge for being the first one to play with me.
        ... Thanks for all the love and support in the chat, get home safe."
        <br />- Alec{" "}
        <a href="https://www.twitch.tv/theoffensiveline/clip/PiercingWrongSandpiperHeyGuys-tHxYpR7ty-xE8_B0">
          wrapping up stream
        </a>
      </LeagueQuote>
      <ImageWrapper>
      ...
      <p>
        Alec completed his 24 hour Fortnite stream punishment this week, from 8pm ET Sunday to about
        9pm ET on Monday. During the stream, Alec earned 4 Victory Royales, consumed 1.78125 gallons
        of liquid, and pissed 24 times. Alec ended up with 84 kills for a 1.09 K/D in his games, and
        had 14 top 10% finishes, and 28 top 25% finishes. 0 dreams about Fortnite were had after 24
        straight hours of playing. Alec also did an epilogue stream on Tuesday for a few hours,
        where he got a few more Victory Royales, and drank a few more seltzers.
      </p>
      <p>
        Some managers are saying the punishment was too easy, since Alec wasn't really feeling upset
        about it afterwards, and did another Fortnite stream the next day.
      </p>
      <LeagueQuote>
        "Next year loser has to go to Disney"
        <br />- Matt Smith
      </LeagueQuote>
      <p>
        This did seem like the easiest punishment the league has had so far, with Alec vouching that
        the ACT was worse than this. Whether the calendar or the 30 challenge were worse could be
        debatable, but this was definitely not as much of a punishment as some managers may have
        anticipated.
      </p>
      <p>
        About 15 hours in, Anthony joined the stream and complained about the audio quailty, causing
        Alec to attempt to reset the connection between his headset and his PC. This caused the PC
        to crash, ruining the Twitch timer, and the stream was not 24 consecutive hours of Fortnite,
        per the rules.
      </p>
      <ArticleSubheader>Championship Results</ArticleSubheader>
      <LeagueQuote>
        "Congrats Trevor no one cares 🥰🥰🥰"
        <br />- Anthony
      </LeagueQuote>
      <p>
        Greg mentioned there are 480 reasons to care, and Trevor had received multiple
        congratulatory texts from other managers prior to this claim that no one cares.
      </p>
      <LeagueQuote>
        "The Commissioner's Office extends a big thank you to Trevor for bravely preventing Greg
        from winning the league"
        <br />- Anonymous League Manager
      </LeagueQuote>
      <p>
        This anonymous manager also seemed to care about Trevor winning the league, or maybe cared
        more about Greg not winning.
      </p>
    </div>
  );
};
...
const Meme1 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ff70i.jpg"}></ArticleImage>
...
const Meme2 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ff78t.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme3 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffc4n.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme4 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffcb3.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme5 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffcc7.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme6 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffcex.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme7 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffckc.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme8 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffcwo.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme9 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffcoz.gif"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
...
const Meme10 = () => {
  return (
    <ImageWrapper>
      <ArticleImage src={"https://i.imgflip.com/9ffd1e.jpg"}></ArticleImage>
      <ArticleCaption>Submitted by The Offensive Line</ArticleCaption>
    </ImageWrapper>
  );
};
