...
const TopStoryArticle = () => {
  return (
    <div>
      ...
      <p>
        In a developing story, the league funds have yet to be allocated where they belong, 5 months
        after the season has ended. We've received multiple alerts from concerned readers and local
        bylaw enforcement officers.
      </p>
      <LeagueQuote>
        "We're receiving reports of a Black Toyota Corolla with New York plates racing towards the
        Mexican border. It's estimated the driver is fleeing with a small fortune stolen from their
        fellow fantasy football managers."
        <br />- Austin PD
      </LeagueQuote>
      <p>
        Chief Correspondent ChatGPT was able to get a photo of the Corolla on it's way to the
        border.
      </p>
      <ArticleImage src={img2920} />
      <ArticleCaption>Submitted by Chief Correspondent ChatGPT</ArticleCaption>
      <p>
        It remains unclear whether this is an inside job or not, but we reached out to the league
        office for comment on the matter.
      </p>
      <LeagueQuote>
        "The commissioners office is aware of the situation and is in an information gathering
        phase. No further comment at this time"
      </LeagueQuote>
      <p>
        It is responsible for the league to take this stance without all the evidence available to
        them, but readers will have to continue to push if they'd like to see this story resolve.
      </p>
    </div>
  );
};
...
const NextSeasonArticle = () => {
  return (
    <div>
      ...
      <p>
        While we are still waiting for last season's reward and punishment, next season is quickly
        approaching. The NFL draft is today, and the fantasy draft is only a few months away. There
        were a number of ideas floated during and after last season for new punishments, rule
        changes, and MotW changes. This article serves to refresh everyone's memory of them, and
        spark a conversation about what they'd like to see. Ultimately we will want to vote before
        our draft and buy in.
      </p>
      <p>
        ...
        <ul>
          ...
          <li>
            <a href="https://i2-prod.dailystar.co.uk/incoming/article24465473.ece/ALTERNATES/s1200e/0_JmTLxztjpeg.jpg">
              Circle Beard
            </a>
          </li>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Adding more options to above format like McDonalds ice cream cone, wings, loaf of bread,
            etc.
          </li>
          <li>Podcast recapping previous weeks events</li>
          <li>
            Tiktok dance or other Tiktok content - maybe just posting current punishment videos on
            Tiktok to try to fund league
          </li>
        </ul>
      </p>
      <p>
