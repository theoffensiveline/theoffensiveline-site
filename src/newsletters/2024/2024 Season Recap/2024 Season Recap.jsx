    ...
    <div>
      ...
      <RecapPositionTable
        data={starterData.filter(
          (item) => item.position === "QB" && item.games_played >= 8 && item.ppg >= 19
        )}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "QB" && item.games_played >= 8 && item.ppg < 19)
          .reverse()}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "QB" && item.games_played < 8 && item.ppg < 15)
          .reverse()}
        selectedTeam={selectedTeam}
      />
    </div>
...
const RBArticle = () => {
  ...
  return (
    <div>
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "RB" && item.games_played >= 8 && item.ppg < 16)
          .reverse()}
        selectedTeam={selectedTeam}
      />
...
const WRArticle = () => {
  ...
  return (
    <div>
      ...
      <RecapPositionTable
        data={starterData.filter(
          (item) => item.position === "WR" && item.games_played >= 8 && item.ppg >= 16
        )}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "WR" && item.games_played >= 8 && item.ppg <= 14)
          .reverse()}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "WR" && item.games_played < 8 && item.ppg < 6)
          .reverse()}
        selectedTeam={selectedTeam}
      />
    </div>
...
const TEArticle = () => {
  ...
  return (
    <div>
      ...
      <RecapPositionTable
        data={starterData.filter(
          (item) => item.position === "TE" && item.games_played >= 8 && item.ppg >= 12
        )}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "TE" && item.games_played >= 8 && item.ppg < 12)
          .reverse()}
        selectedTeam={selectedTeam}
      />
...
const KArticle = () => {
  ...
  return (
    <div>
      ...
      <RecapPositionTable
        data={starterData.filter(
          (item) => item.position === "K" && item.games_played >= 8 && item.ppg >= 10
        )}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "K" && item.games_played >= 8 && item.ppg < 10)
          .reverse()}
        selectedTeam={selectedTeam}
      />
      ...
      <RecapPositionTable
        data={starterData
          .filter((item) => item.position === "K" && item.games_played < 8 && item.ppg < 7)
          .reverse()}
        selectedTeam={selectedTeam}
      />
...
const ThankYouArticle = () => {
  return (
    <div>
      ...
      <p>
        Thank you for reading the 2024 Season Recap. We hope you enjoyed it, and we are looking
