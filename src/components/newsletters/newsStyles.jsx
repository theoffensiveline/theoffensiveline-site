  ...
  return (
    <div>
      ...
      <p style={{ textIndent: "2em" }}>
        2a. If the loser fails to submit their video on time, they must add 1 extra shot or hotdog
        for the first week it's late, 2 extra for the second week, 3 extra for the third week, and
        so on. The additional penalty grows each week, and all penalties are added to their original
        total.
      </p>
      <p style={{ textIndent: "2em" }}>
        2b. Nikhil Clause - If you are granted an extension, and do not meet the extended deadline,
        the extension is revoked and you owe the full amount of shots or dogs as if it was a normal
        late penalty.
      </p>
