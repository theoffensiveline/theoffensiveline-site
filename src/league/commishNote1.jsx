    ...
    return (
        <CommissionerNoteWrapper>
            ...
            <CommissionerNoteContent>
                ...
                <br />
                <br />
                As per our league's rules and guidelines, for each additional week that Nikhil is late in completing the punishment, he will be required to consume an additional hotdog or shot, depending on the original choice for the penalty.
                <br />
                <br />
